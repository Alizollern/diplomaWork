...
<section class="recept-title">
    <div class="container">
        <div class="title">
            ...
            <form action="{{ route('medicines.search') }}" class="price-form" style="">
                <input type="text" class="form-control" name="name" id="" placeholder="Name" style="width: 50%; height: 30px;">
